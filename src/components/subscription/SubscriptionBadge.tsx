...
export function FeatureBadge({ featureKey, className = '', showTooltip = false }: FeatureBadgeProps) {
  ...
  const featureConfig: Record<FeatureKey, { icon: any; label: string; tier: string }> = {
    ...
    ai_insights: { icon: Star, label: t('premium_feature'), tier: 'premium' },
    ai_financial_advisor: { icon: Star, label: t('premium_feature'), tier: 'premium' },
    ai_budget_optimization: { icon: Star, label: t('premium_feature'), tier: 'premium' },
    ai_spending_analysis: { icon: Star, label: t('premium_feature'), tier: 'premium' },
